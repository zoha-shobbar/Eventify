using Eventify.Shared.Controllers.Categories;
using Eventify.Shared.Dtos.Categories;

namespace Eventify.Client.Core.Components.Pages.Authorized.Categories;
