...
namespace Eventify.Server.Api.Data.Configurations.Identity;
...
public partial class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        DateTimeOffset baseDate = DateTimeOffset.Parse("2025-03-04", styles: DateTimeStyles.AssumeUniversal);
